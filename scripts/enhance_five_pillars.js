...
<style id="five-pillars-seo-geo">
  .five-pillars-guide{background:#f4f7f8;color:#17232b;padding:64px 24px;font-family:"Source Sans Pro",Arial,sans-serif}
  .five-pillars-guide__inner{max-width:1120px;margin:0 auto}
  .five-pillars-guide h2{font-size:clamp(30px,4vw,48px);line-height:1.08;margin:0 0 18px;color:#17232b}
  .five-pillars-guide h3{font-size:23px;line-height:1.25;margin:0 0 8px;color:#17232b}
  .five-pillars-guide p,.five-pillars-guide summary,.five-pillars-guide dd{font-size:18px;line-height:1.6}
  .five-pillars-guide__lead{max-width:780px;margin:0 0 34px}
  ...
  .five-pillars-guide details{margin:12px 0}
  .five-pillars-guide summary{font-weight:700;cursor:pointer}
  .five-pillars-guide dd{margin:12px 0 0}
  .five-pillars-guide__transcript{border-left:4px solid #087f86;padding-left:18px;max-width:850px}
...
<section class="five-pillars-guide" aria-labelledby="${slug}-guide-title">
  <div class="five-pillars-guide__inner">
    <p><strong>Pillar ${data.number} of 5</strong></p>
