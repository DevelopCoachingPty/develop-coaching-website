...
.dc-article-intro{--ink:#25262a;--quiet:#5d5b54;--signal:#f6c944;margin:0 0 44px}
...
.dc-article-brief{--ink:#25262a;--paper:#f7f5ef;--edge:#e3dfd2;--rule:#d5d0c0;--quiet:#5d5b54;--signal:#f6c944;--teal:#0b7c83;
...
.dc-article-brief__panel h3:before{content:"";position:absolute;top:0;left:0;width:26px;height:3px;background:var(--teal)}
...
.dc-article-brief__review{margin:30px 0 0!important;padding:20px 24px!important;background:#efeade;border-left:3px solid var(--signal);color:var(--ink)!important;font-size:15.5px!important;font-weight:400!important;line-height:1.68!important}
.dc-article-brief__review strong{display:block;margin-bottom:6px;color:var(--teal);font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10.5px;font-weight:700;letter-spacing:.18em;text-transform:uppercase}
...
.dc-article-brief__link:hover{background:var(--teal);gap:14px}
.dc-article-brief__link:focus-visible{background:var(--teal);outline:3px solid var(--ink);outline-offset:3px}
